...
func (v *Vector3) GetAxis(axis Vec3Axis) float64 {
	return godotRealAsReal(C.godot_vector3_get_axis(v.vector3, vec3AxisAsGodotVec3Axis(axis)))
}
...
func (v *Vector3) OperatorDivideScalar(with float64) *Vector3 {
	return godotVec3AsVec3(C.godot_vector3_operator_divide_scalar(v.vector3, realAsGodotReal(with)))
}

//OperatorDivideVector multiplys the current vector and with.
func (v *Vector3) OperatorDivideVector(with Vector3) *Vector3 {
	return godotVec3AsVec3(C.godot_vector3_operator_divide_vector(v.vector3, with.vector3))
}
...
func (v *Vector3) OperatorMultiplyScalar(with float64) *Vector3 {
	return godotVec3AsVec3(C.godot_vector3_operator_multiply_scalar(v.vector3, realAsGodotReal(with)))
}

//OperatorMultiplyVector multiplys the current vector and with.
func (v *Vector3) OperatorMultiplyVector(with Vector3) *Vector3 {
	return godotVec3AsVec3(C.godot_vector3_operator_multiply_vector(v.vector3, with.vector3))
}
...
func (v *Vector3) OperatorSubtract(with Vector3) *Vector3 {
	return godotVec3AsVec3(C.godot_vector3_operator_substract(v.vector3, with.vector3))
}
...
func (v *Vector3) Rotated(by Vector3, phi float64) *Vector3 {
	return godotVec3AsVec3(C.godot_vector3_rotated(v.vector3, by.vector3, realAsGodotReal(phi)))
}

//SetAxis changes the specified axis to the specified value.
func (v *Vector3) SetAxis(axis Vec3Axis, val float64) {
	C.godot_vector3_set_axis(v.vector3, vec3AxisAsGodotVec3Axis(axis), realAsGodotReal(val))
}
