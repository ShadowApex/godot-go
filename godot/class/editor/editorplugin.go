...
import (
	...
	"github.com/shadowapex/godot-go/godot/class/undoredo"
	...
	"github.com/shadowapex/godot-go/godot/class/toolbutton"
...
func (o *EditorPlugin) AddControlToBottomPanel(control object.Object, title gdnative.String) toolbutton.ToolButton {
	...
	// ToolButton
	retPtr := toolbutton.NewEmptyToolButton()
	gdnative.MethodBindPtrCall(methodBind, o.GetOwner(), ptrArguments, retPtr)

	// If we have a return type, convert it from a pointer into its actual object.
	ret := toolbutton.NewToolButtonFromPointer(retPtr)
...
func (o *EditorPlugin) AddControlToContainer(container gdnative.Int, control object.Object) {
	log.Println("Calling EditorPlugin.AddControlToContainer()")

	// Build out the method's arguments
	ptrArguments := make([]gdnative.Pointer, 2, 2)
	ptrArguments[0] = gdnative.NewPointerFromInt(container)
	ptrArguments[1] = gdnative.NewPointerFromObject(control.GetOwner())
...
func (o *EditorPlugin) AddControlToDock(slot gdnative.Int, control object.Object) {
...
func (o *EditorPlugin) AddCustomType(aType gdnative.String, base gdnative.String, script script.Script, icon texture.Texture) {
	...
	ptrArguments[2] = gdnative.NewPointerFromObject(script.GetOwner())
	ptrArguments[3] = gdnative.NewPointerFromObject(icon.GetOwner())
...
func (o *EditorPlugin) AddExportPlugin(exporter EditorExportPlugin) {
	...
	ptrArguments[0] = gdnative.NewPointerFromObject(exporter.GetOwner())
...
func (o *EditorPlugin) AddImportPlugin(importer EditorImportPlugin) {
	...
	// Build out the method's arguments
	ptrArguments := make([]gdnative.Pointer, 1, 1)
	ptrArguments[0] = gdnative.NewPointerFromObject(importer.GetOwner())
...
func (o *EditorPlugin) AddSceneImportPlugin(sceneImporter EditorSceneImporter) {
	...
	// Build out the method's arguments
	ptrArguments := make([]gdnative.Pointer, 1, 1)
	ptrArguments[0] = gdnative.NewPointerFromObject(sceneImporter.GetOwner())
...
func (o *EditorPlugin) AddToolSubmenuItem(name gdnative.String, submenu object.Object) {
	log.Println("Calling EditorPlugin.AddToolSubmenuItem()")

	// Build out the method's arguments
	ptrArguments := make([]gdnative.Pointer, 2, 2)
	ptrArguments[0] = gdnative.NewPointerFromString(name)
	ptrArguments[1] = gdnative.NewPointerFromObject(submenu.GetOwner())
...
func (o *EditorPlugin) CreateSpatialGizmo(forSpatial spatial.Spatial) EditorSpatialGizmo {
	log.Println("Calling EditorPlugin.CreateSpatialGizmo()")

	// Build out the method's arguments
	ptrArguments := make([]gdnative.Pointer, 1, 1)
	ptrArguments[0] = gdnative.NewPointerFromObject(forSpatial.GetOwner())
	...
	// Call the parent method.
	// EditorSpatialGizmo
	retPtr := NewEmptyEditorSpatialGizmo()
	gdnative.MethodBindPtrCall(methodBind, o.GetOwner(), ptrArguments, retPtr)
...
func (o *EditorPlugin) Edit(object object.Object) {
...
func (o *EditorPlugin) ForwardCanvasGuiInput(event inputevent.InputEvent) gdnative.Bool {
...
func (o *EditorPlugin) ForwardDrawOverViewport(overlay control.Control) {
	log.Println("Calling EditorPlugin.ForwardDrawOverViewport()")

	// Build out the method's arguments
	ptrArguments := make([]gdnative.Pointer, 1, 1)
	ptrArguments[0] = gdnative.NewPointerFromObject(overlay.GetOwner())
...
func (o *EditorPlugin) ForwardForceDrawOverViewport(overlay control.Control) {
...
func (o *EditorPlugin) ForwardSpatialGuiInput(camera camera.Camera, event inputevent.InputEvent) gdnative.Bool {
...
func (o *EditorPlugin) GetPluginIcon() object.Object {
...
func (o *EditorPlugin) GetUndoRedo() undoredo.UndoRedo {
	...
	// Call the parent method.
	// UndoRedo
	retPtr := undoredo.NewEmptyUndoRedo()
	gdnative.MethodBindPtrCall(methodBind, o.GetOwner(), ptrArguments, retPtr)

	// If we have a return type, convert it from a pointer into its actual object.
	ret := undoredo.NewUndoRedoFromPointer(retPtr)
...
func (o *EditorPlugin) GetWindowLayout(layout configfile.ConfigFile) {
	log.Println("Calling EditorPlugin.GetWindowLayout()")

	// Build out the method's arguments
	ptrArguments := make([]gdnative.Pointer, 1, 1)
	ptrArguments[0] = gdnative.NewPointerFromObject(layout.GetOwner())
...
func (o *EditorPlugin) Handles(object object.Object) gdnative.Bool {
...
func (o *EditorPlugin) MakeBottomPanelItemVisible(item object.Object) {
...
func (o *EditorPlugin) RemoveControlFromBottomPanel(control object.Object) {
...
func (o *EditorPlugin) RemoveControlFromContainer(container gdnative.Int, control object.Object) {
...
func (o *EditorPlugin) RemoveControlFromDocks(control object.Object) {
...
func (o *EditorPlugin) SetWindowLayout(layout configfile.ConfigFile) {
