...
func (o *physicsServer) AreaSetMonitorCallback(area gdnative.RID, receiver object.Object, method gdnative.String) {
...
func (o *physicsServer) BodyGetDirectState(body gdnative.RID) PhysicsDirectBodyState {
	...
	retPtr := NewEmptyPhysicsDirectBodyState()
	gdnative.MethodBindPtrCall(methodBind, o.GetOwner(), ptrArguments, retPtr)
...
func (o *physicsServer) BodySetForceIntegrationCallback(body gdnative.RID, receiver object.Object, method gdnative.String, userdata gdnative.Variant) {
