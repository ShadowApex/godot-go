...
func (o *inputMap) ActionAddEvent(action gdnative.String, event inputevent.InputEvent) {
...
func (o *inputMap) ActionEraseEvent(action gdnative.String, event inputevent.InputEvent) {
...
func (o *inputMap) ActionHasEvent(action gdnative.String, event inputevent.InputEvent) gdnative.Bool {
...
func (o *inputMap) EventIsAction(event inputevent.InputEvent, action gdnative.String) gdnative.Bool {
