...
func (o *Theme) GetDefaultFont() font.Font {
...
func (o *Theme) GetFont(name gdnative.String, aType gdnative.String) font.Font {
...
func (o *Theme) GetIcon(name gdnative.String, aType gdnative.String) texture.Texture {
...
func (o *Theme) GetStylebox(name gdnative.String, aType gdnative.String) stylebox.StyleBox {
...
func (o *Theme) SetDefaultFont(font font.Font) {
...
func (o *Theme) SetFont(name gdnative.String, aType gdnative.String, font font.Font) {
	...
	ptrArguments[0] = gdnative.NewPointerFromString(name)
	ptrArguments[1] = gdnative.NewPointerFromString(aType)
	ptrArguments[2] = gdnative.NewPointerFromObject(font.GetOwner())
...
func (o *Theme) SetIcon(name gdnative.String, aType gdnative.String, texture texture.Texture) {
	...
	ptrArguments[0] = gdnative.NewPointerFromString(name)
	ptrArguments[1] = gdnative.NewPointerFromString(aType)
	ptrArguments[2] = gdnative.NewPointerFromObject(texture.GetOwner())
...
func (o *Theme) SetStylebox(name gdnative.String, aType gdnative.String, texture stylebox.StyleBox) {
