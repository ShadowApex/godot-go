...
import (
	...
	"github.com/shadowapex/godot-go/godot/class/audioeffect"
	"github.com/shadowapex/godot-go/godot/class/object"

	"github.com/shadowapex/godot-go/godot/class/audiobuslayout"
)
...
func (o *audioServer) AddBusEffect(busIdx gdnative.Int, effect audioeffect.AudioEffect, atPosition gdnative.Int) {
	log.Println("Calling AudioServer.AddBusEffect()")

	// Build out the method's arguments
	ptrArguments := make([]gdnative.Pointer, 3, 3)
	ptrArguments[0] = gdnative.NewPointerFromInt(busIdx)
	ptrArguments[1] = gdnative.NewPointerFromObject(effect.GetOwner())
...
func (o *audioServer) GenerateBusLayout() audiobuslayout.AudioBusLayout {
	...
	// Call the parent method.
	// AudioBusLayout
	retPtr := audiobuslayout.NewEmptyAudioBusLayout()
	gdnative.MethodBindPtrCall(methodBind, o.GetOwner(), ptrArguments, retPtr)

	// If we have a return type, convert it from a pointer into its actual object.
	ret := audiobuslayout.NewAudioBusLayoutFromPointer(retPtr)
...
func (o *audioServer) GetBusEffect(busIdx gdnative.Int, effectIdx gdnative.Int) audioeffect.AudioEffect {
	...
	// Call the parent method.
	// AudioEffect
	retPtr := audioeffect.NewEmptyAudioEffect()
	gdnative.MethodBindPtrCall(methodBind, o.GetOwner(), ptrArguments, retPtr)

	// If we have a return type, convert it from a pointer into its actual object.
	ret := audioeffect.NewAudioEffectFromPointer(retPtr)
...
func (o *audioServer) SetBusLayout(busLayout audiobuslayout.AudioBusLayout) {
	log.Println("Calling AudioServer.SetBusLayout()")

	// Build out the method's arguments
	ptrArguments := make([]gdnative.Pointer, 1, 1)
	ptrArguments[0] = gdnative.NewPointerFromObject(busLayout.GetOwner())
