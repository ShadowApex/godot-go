...
func (o *GraphNode) X_GuiInput(arg0 inputevent.InputEvent) {
...
func (o *GraphNode) SetSlot(idx gdnative.Int, enableLeft gdnative.Bool, typeLeft gdnative.Int, colorLeft gdnative.Color, enableRight gdnative.Bool, typeRight gdnative.Int, colorRight gdnative.Color, customLeft texture.Texture, customRight texture.Texture) {
	...
	ptrArguments[7] = gdnative.NewPointerFromObject(customLeft.GetOwner())
	ptrArguments[8] = gdnative.NewPointerFromObject(customRight.GetOwner())
