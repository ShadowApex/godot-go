...
import (
	...
	"github.com/shadowapex/godot-go/godot/class/kinematiccollision"
...
func (o *KinematicBody) GetSlideCollision(slideIdx gdnative.Int) kinematiccollision.KinematicCollision {
	...
	// Call the parent method.
	// KinematicCollision
	retPtr := kinematiccollision.NewEmptyKinematicCollision()
	gdnative.MethodBindPtrCall(methodBind, o.GetOwner(), ptrArguments, retPtr)

	// If we have a return type, convert it from a pointer into its actual object.
	ret := kinematiccollision.NewKinematicCollisionFromPointer(retPtr)
...
func (o *KinematicBody) MoveAndCollide(relVec gdnative.Vector3) kinematiccollision.KinematicCollision {
