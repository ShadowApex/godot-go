...
func (o *PopupMenu) X_GuiInput(arg0 inputevent.InputEvent) {
...
func (o *PopupMenu) AddCheckShortcut(shortcut shortcut.ShortCut, id gdnative.Int, global gdnative.Bool) {
...
func (o *PopupMenu) AddIconCheckItem(texture texture.Texture, label gdnative.String, id gdnative.Int, accel gdnative.Int) {
...
func (o *PopupMenu) AddIconCheckShortcut(texture texture.Texture, shortcut shortcut.ShortCut, id gdnative.Int, global gdnative.Bool) {
	log.Println("Calling PopupMenu.AddIconCheckShortcut()")

	// Build out the method's arguments
	ptrArguments := make([]gdnative.Pointer, 4, 4)
	ptrArguments[0] = gdnative.NewPointerFromObject(texture.GetOwner())
	ptrArguments[1] = gdnative.NewPointerFromObject(shortcut.GetOwner())
	ptrArguments[2] = gdnative.NewPointerFromInt(id)
...
func (o *PopupMenu) AddIconItem(texture texture.Texture, label gdnative.String, id gdnative.Int, accel gdnative.Int) {
...
func (o *PopupMenu) AddIconShortcut(texture texture.Texture, shortcut shortcut.ShortCut, id gdnative.Int, global gdnative.Bool) {
...
func (o *PopupMenu) AddShortcut(shortcut shortcut.ShortCut, id gdnative.Int, global gdnative.Bool) {
...
func (o *PopupMenu) GetItemIcon(idx gdnative.Int) texture.Texture {
...
func (o *PopupMenu) GetItemShortcut(idx gdnative.Int) shortcut.ShortCut {
...
func (o *PopupMenu) SetItemIcon(idx gdnative.Int, icon texture.Texture) {
...
func (o *PopupMenu) SetItemShortcut(idx gdnative.Int, shortcut shortcut.ShortCut, global gdnative.Bool) {
