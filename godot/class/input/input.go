...
func (o *input) ParseInputEvent(event inputevent.InputEvent) {
...
func (o *input) SetCustomMouseCursor(image resource.Resource, shape gdnative.Int, hotspot gdnative.Vector2) {
