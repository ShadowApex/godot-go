...
func (t *Variant) AsString() String {
	arg0 := t.getBase()
...
func (t *Variant) AsVector2() Vector2 {
	arg0 := t.getBase()
...
func (t *Variant) AsVector3() Vector3 {
	arg0 := t.getBase()
...
func (t *Variant) AsTransform2D() Transform2D {
	arg0 := t.getBase()
...
func (t *Variant) AsTransform() Transform {
	arg0 := t.getBase()
...
func (t *Variant) AsNodePath() NodePath {
	arg0 := t.getBase()
...
func (t *Variant) AsObject() Object {
	arg0 := t.getBase()
...
func (t *Variant) AsDictionary() Dictionary {
	arg0 := t.getBase()
...
func (t *Variant) AsPoolByteArray() PoolByteArray {
	arg0 := t.getBase()
...
func (t *Variant) AsPoolIntArray() PoolIntArray {
	arg0 := t.getBase()
...
func (t *Variant) AsPoolRealArray() PoolRealArray {
	arg0 := t.getBase()
...
func (t *Variant) AsPoolStringArray() PoolStringArray {
	arg0 := t.getBase()
...
func (t *Variant) AsPoolVector2Array() PoolVector2Array {
	arg0 := t.getBase()
...
func (t *Variant) AsPoolVector3Array() PoolVector3Array {
	arg0 := t.getBase()
...
func (t *Variant) AsPoolColorArray() PoolColorArray {
	arg0 := t.getBase()
...
func (t *Variant) Call(method String, args []Variant, argcount Int, error VariantCallError) Variant {
	arg0 := t.getBase()
	arg1 := method.getBase()
	arg2 := args.getBase()
...
func (t *Variant) HasMethod(method String) Bool {
	arg0 := t.getBase()
	arg1 := method.getBase()
...
func (t *Variant) OperatorEqual(other Variant) Bool {
	arg0 := t.getBase()
	arg1 := other.getBase()
...
func (t *Variant) OperatorLess(other Variant) Bool {
	arg0 := t.getBase()
	arg1 := other.getBase()
...
func (t *Variant) HashCompare(other Variant) Bool {
	arg0 := t.getBase()
	arg1 := other.getBase()
...
func (t *Variant) Booleanize() Bool {
	arg0 := t.getBase()
